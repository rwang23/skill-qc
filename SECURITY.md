...
Use [GitHub Security Advisories](https://github.com/rwang23/skill-qc/security/advisories/new) for suspected vulnerabilities. Please include the affected revision, a minimal reproduction, and the expected versus observed boundary.
...
SkillQC is a static review aid, not a sandbox. It never grants authority to install or execute an audited Skill.
